...
class BarberLocationActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        BottomSheetBehavior.from(binding.CLQueue).apply {
            ...
            addBottomSheetCallback(object : BottomSheetBehavior.BottomSheetCallback() {
                ...
                override fun onSlide(bottomSheet: View, slideOffset: Float) {
                    ...
                    binding.IBBarberFocus.alpha = 1 - slideOffset * 0.6f
        ...
        binding.apply {
            ...
            Glide.with(this@BarberLocationActivity).load(barberData.logo).circleCrop()
                .into(IBBarberFocus)

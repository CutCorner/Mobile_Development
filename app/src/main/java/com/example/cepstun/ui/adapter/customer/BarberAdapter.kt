...
class BarberAdapter : ListAdapter<BarberData, BarberAdapter.BarberViewHolder>(BarberDiffCallback) {
    ...
    companion object{
        val BarberDiffCallback = object : DiffUtil.ItemCallback<BarberData>() {
